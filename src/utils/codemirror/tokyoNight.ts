...
/**
 * credit: https://github.com/uiwjs/react-codemirror/blob/master/themes/tokyo-night/src/index.ts
 * package wasn't working well with default codemirror extensions
 */
...
export const tokyoNightSyntax = HighlightStyle.define([
